...
class startmenu(Frame):
    ...
    def start_menu_initializer(self):
        ...
        self.Start_button_image = Image.setImage("Assets/Shell/Desktop/Start menu/Start_icon.png", (24, 24), "#ff00ff",
                                                 "#002C4F")
        self.Start_button_light = Image.setImage("Assets/Shell/Desktop/Start menu/Start_icon.png", (24, 24), "#ff00ff",
                                                 "#00345B")
