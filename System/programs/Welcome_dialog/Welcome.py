...
class Welcome_dialog(Frame):
    ...
    def __init__(self, master, draggable: bool = True):
        ...
        self.Welcome_window_image = Image.setImage(
            "Assets/Shell/Programs/Welcome dialog/Window.png")  # Welcome dialog image base
        ...
        self.Close_button_red_image = Image.setImage(
            "Assets/Shell/Window/Close_button_red.png")  # Window close red button
